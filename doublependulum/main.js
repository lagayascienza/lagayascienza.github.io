...
if(window.matchMedia("(max-width: 600px)").matches){mobile = true}
if(window.matchMedia("(max-width: 1366px)").matches && !mobile){laptop = true}
...
let animateMovement = function(){
    ...
    let traj_width;
    if(mobile){traj_width = 1.5; context.globalAlpha = 0.1}
    else if(laptop) {traj_width = 0.05}
    else {traj_width = 0.02}
